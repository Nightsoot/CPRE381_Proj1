...
def random_cases():
    ...
    for i in range(1, 101):
        ...
        #write_assertion("s_zero", 1, None, message=f"Case {case_num} zero flag failed") #Not a constant for randomized testing
        #write_assertion("s_negative", 1, None, message=f"Case {case_num} negative flag failed") #Not a constant for randomized testing
        #write_assertion("s_carry_out", 1, None, message=f"Case {case_num} carry flag failed") #Not a constant for randomized testing
        #write_assertion("s_overflow", 1, None, message=f"Case {case_num} overflow flag failed") #Not a constant for randomized testing
        write_wait()
        increment_case()
        f.write('\n')
